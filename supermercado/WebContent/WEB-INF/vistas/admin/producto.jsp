...
<form action="" method="post" class="needs-validation" novalidate>
	...
	<div class="form-group row">
		...
		<div class="col">
			<input type="number" class="form-control ${producto.errorId != null ? 'is-invalid' : '' }" id="id" name="id"
			value="${producto.id}"	readonly placeholder="Id del producto">
	...
	<div class="form-group row">
		...
		<div class="col">
			<input type="number" class="form-control ${producto.errorCantidad != null ? 'is-invalid' : '' }" id="cantidad"
				name="cantidad" value="${producto.cantidad}" required min="0" />
	...
	<div class="form-group row">
		...
		<div class="input-group col">
			<input type="number" step=".01" min="0" class="form-control ${producto.errorPrecioUnidadMedida != null ? 'is-invalid' : ''}"
				id="precio-unidad-medida" name="precio-unidad-medida" value="${producto.precioUnidadMedida}"/>
