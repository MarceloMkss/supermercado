		...
		<div class="col mb-4">
			<div class="card h-100">
					...
					<p class="card-text">
						<div class="input-group mx-auto" style="width: 9rem">
							<div class="input-group-prepend">
								...
								id="button-addon1"><i class="fas fa-minus" style="color: #F44336;"></i></button>
  							</div>
  							<input type="text" class="form-control text-center font-weight-bold" placeholder=""
							aria-label=""
							aria-describedby="button-addon1" value="1" />
							<div class="input-group-append">
    							<button class="btn btn-secondary" type="button"
    							 id="button-addon2"><i class="fas fa-plus" style="color: #00c22a;" ></i></button>
  							</div>
						</div>
					</p>
				...
				<div class="card-footer bg-primary p-0" >
					<a href="#" class="btn btn-block text-white" style="background: #1c9a1a;">Añadir al carrito</a>
				</div>
			</div>
		</div>
